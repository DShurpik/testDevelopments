...
проперти файлов
10. mvn clean test -DsuiteXml=Profiles -Dprofile=dev -Dconfig=config для комбинированного запуска тестов с разными профилями и различными проперти файлами конфигурации